	        ...
	        <div class="col-md-12">
	            <div class="panel panel-default">
	                ...
	                <div class="panel-body">
	                	<form action="{{ route('adminPostCreateRestaurant') }}" method="post">
	                		{{ csrf_field() }}
                			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
	                			<div class="form-group">
		                			<label for="name">Restaurant Name</label>
		                			<input type="text" name="name" id="name" class="form-control" placeholder="Restaurant Name" value="{{ old('name') }}">
		                			@if($errors->has('name'))
	                		...
	                		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		                		<div class="form-group">
		                			...
		                			<input type="text" name="description" id="description" class="form-control" placeholder="Restaurant Description" value="{{ old('description') }}">
                			...
                			<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
	                			<div class="form-group">
		                			...
		                			<input type="text" name="lat" id="lat" class="form-control" placeholder="Restaurant lat" value="{{ old('lat') }}">
		                			@if($errors->has('lat'))
							...
							<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
								<div class="form-group">
		                			...
		                			<input type="text" name="lng" id="lng" class="form-control" placeholder="Restaurant lng" value="{{ old('lng') }}">
		                			@if($errors->has('lng'))
